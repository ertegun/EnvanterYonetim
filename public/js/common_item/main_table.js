    ...
    columns: [
        ...
        },
        {
            ...
            render:function(row){
                ...
                <a onclick="commonItemUpdate('${row.id}')" data-toggle="modal" data-target="#commonItemUpdateModal">
                ...
                if(row.owner_count == 0){
                    ...
                    <a onclick="commonItemDelete('${row.id}')" data-toggle="modal" data-target="#commonItemDeleteModal">
